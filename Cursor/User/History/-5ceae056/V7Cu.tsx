...
export default function LoginScreen() {
  const { setAuth, hydrate, loginAsDemo } = useAuth();
  ...
  return (
    <View style={styles.container}>
      ...
      <Link to={{ screen: 'Register' }} style={{ color: colors.primaryDark } as any}>Create an account</Link>
      <View style={{ height: 20 }} />
      <Button title="Continue as demo" onPress={loginAsDemo} color={colors.primary} />
